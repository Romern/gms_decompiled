...
public class FillContentLayout extends FrameLayout {
    ...
    /* renamed from: a */
    private static int m4739a(int i, int i2, int i3) {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            childAt.measure(m4739a(Math.min(this.f7234a, measuredWidth), getPaddingLeft() + getPaddingRight() + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin, marginLayoutParams.width), m4739a(Math.min(this.f7235b, measuredHeight), getPaddingTop() + getPaddingBottom() + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin, marginLayoutParams.height));
        }
    }

    public FillContentLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0126R.attr.suwFillContentLayoutStyle);
    }

    public FillContentLayout(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, blz.f5139f, i, 0);
        this.f7235b = obtainStyledAttributes.getDimensionPixelSize(1, -1);
        this.f7234a = obtainStyledAttributes.getDimensionPixelSize(0, -1);
