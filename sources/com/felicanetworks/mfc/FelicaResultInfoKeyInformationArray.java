...
public class FelicaResultInfoKeyInformationArray extends FelicaResultInfoType implements Parcelable {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
        /* class com.felicanetworks.mfc.FelicaResultInfoKeyInformationArray.C01081 */
    ...
    public void readFromParcel(Parcel parcel) {
        ...
        Parcelable[] readParcelableArray = parcel.readParcelableArray(KeyInformation.class.getClassLoader());
        if (readParcelableArray != null) {
            this.value = new KeyInformation[readParcelableArray.length];
            for (int i = 0; i < readParcelableArray.length; i++) {
                ((KeyInformation[]) this.value)[i] = (KeyInformation) readParcelableArray[i];
            }
        }
    }
