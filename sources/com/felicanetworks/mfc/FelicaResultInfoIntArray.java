...
public class FelicaResultInfoIntArray extends FelicaResultInfoType implements Parcelable {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
        /* class com.felicanetworks.mfc.FelicaResultInfoIntArray.C01071 */
    ...
    public void readFromParcel(Parcel parcel) {
        ...
        if (readInt >= 0) {
            LogMgr.log(7, "001 length=%d", Integer.valueOf(readInt));
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        LogMgr.log(6, "002 length=%d", Integer.valueOf(i2));
        parcel.writeInt(i2);
