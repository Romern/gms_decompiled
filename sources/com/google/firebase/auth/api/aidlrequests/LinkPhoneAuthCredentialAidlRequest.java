...
public class LinkPhoneAuthCredentialAidlRequest extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new brkd();

    /* renamed from: a */
    public final String f152445a;

    /* renamed from: b */
    public final PhoneAuthCredential f152446b;

    public LinkPhoneAuthCredentialAidlRequest(String str, PhoneAuthCredential phoneAuthCredential) {
        this.f152445a = str;
        this.f152446b = phoneAuthCredential;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        see.m35046a(parcel, 1, this.f152445a, false);
        see.m35040a(parcel, 2, this.f152446b, i, false);
