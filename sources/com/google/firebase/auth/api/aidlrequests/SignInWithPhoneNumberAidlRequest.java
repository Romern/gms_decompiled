...
public class SignInWithPhoneNumberAidlRequest extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new brko();

    /* renamed from: a */
    public final PhoneAuthCredential f152463a;

    /* renamed from: b */
    public final String f152464b;

    public SignInWithPhoneNumberAidlRequest(PhoneAuthCredential phoneAuthCredential, String str) {
        this.f152463a = phoneAuthCredential;
        this.f152464b = str;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        see.m35040a(parcel, 1, this.f152463a, i, false);
        see.m35046a(parcel, 2, this.f152464b, false);
