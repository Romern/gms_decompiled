...
public class ListFragmentProxy extends C1084io implements den {

    /* renamed from: ad */
    private ListFragment f7640ad;
            ...
            if (arguments == null) {
                ...
                if (string == null) {
                    ...
                    try {
                        ...
                        this.f7640ad = (ListFragment) moduleActivity.getClassLoader().loadClass(string).newInstance();
                    ...
                    ListFragment listFragment = this.f7640ad;
                    if (listFragment != null) {
                        listFragment.setImpl((C1084io) this);
                        moduleFragment = this.f7640ad;
                    } else {
    ...
    public void onListItemClick(ListView listView, View view, int i, long j) {
        ListFragment moduleFragment = getModuleFragment();
        if (moduleFragment != null) {
            moduleFragment.onListItemClick(listView, view, i, j);
        }
    }
