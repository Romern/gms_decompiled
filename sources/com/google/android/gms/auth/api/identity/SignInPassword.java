...
public class SignInPassword extends AbstractSafeParcelable {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof SignInPassword) {
            ...
            if (!sdg.m34949a(this.f10255a, signInPassword.f10255a) || !sdg.m34949a(this.f10256b, signInPassword.f10256b)) {
                return false;
            }
            return true;
        }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        see.m35046a(parcel, 1, this.f10255a, false);
        see.m35046a(parcel, 2, this.f10256b, false);
