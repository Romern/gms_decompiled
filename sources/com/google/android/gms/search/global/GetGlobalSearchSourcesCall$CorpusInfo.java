...
public class GetGlobalSearchSourcesCall$CorpusInfo extends AbstractSafeParcelable {
    ...
    /* renamed from: b */
    public Feature[] f107413b;

    /* renamed from: c */
    public boolean f107414c;

    /* renamed from: d */
    public Bundle f107415d;
    ...
    public GetGlobalSearchSourcesCall$CorpusInfo(String str, Feature[] featureArr, boolean z, Bundle bundle) {
        this.f107412a = str;
        this.f107413b = featureArr;
        this.f107414c = z;
        this.f107415d = bundle;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        see.m35046a(parcel, 1, this.f107412a, false);
        see.m35057a(parcel, 2, this.f107413b, i);
        see.m35051a(parcel, 3, this.f107414c);
        see.m35037a(parcel, 4, this.f107415d, false);
