...
public class RegisterCorpusInfoCall$Request extends AbstractSafeParcelable {
    ...
    /* renamed from: c */
    public RegisterCorpusInfo f107402c;
    ...
    public RegisterCorpusInfoCall$Request(String str, String str2, RegisterCorpusInfo registerCorpusInfo) {
        this.f107400a = str;
        this.f107401b = str2;
        this.f107402c = registerCorpusInfo;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        see.m35046a(parcel, 1, this.f107400a, false);
        see.m35046a(parcel, 2, this.f107401b, false);
        see.m35040a(parcel, 3, this.f107402c, i, false);
