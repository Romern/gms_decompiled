...
public class SecurePaymentsPayload extends AbstractSafeParcelable implements ReflectedParcelable {
    public static final Parcelable.Creator CREATOR = new awlj();

    /* renamed from: a */
    public byte[] f110176a;

    /* renamed from: b */
    public SecurePaymentsData[] f110177b;

    public SecurePaymentsPayload(byte[] bArr, SecurePaymentsData[] securePaymentsDataArr) {
        this.f110176a = bArr;
        this.f110177b = securePaymentsDataArr;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        see.m35052a(parcel, 2, this.f110176a, false);
        see.m35057a(parcel, 3, this.f110177b, i);
