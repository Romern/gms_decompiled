...
public class GetSaveInstrumentDetailsResponse extends AbstractSafeParcelable {
    ...
    /* renamed from: a */
    public String[] f110184a;

    /* renamed from: b */
    public int[] f110185b;

    /* renamed from: c */
    public RemoteViews f110186c;

    /* renamed from: d */
    public byte[] f110187d;

    private GetSaveInstrumentDetailsResponse() {
    }

    /* renamed from: a */
    public static awlo m93939a() {
        return new awlo(new GetSaveInstrumentDetailsResponse());
    }

    public GetSaveInstrumentDetailsResponse(String[] strArr, int[] iArr, RemoteViews remoteViews, byte[] bArr) {
        this.f110184a = strArr;
        this.f110185b = iArr;
        this.f110186c = remoteViews;
        this.f110187d = bArr;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        see.m35058a(parcel, 1, this.f110184a, false);
        see.m35055a(parcel, 2, this.f110185b, false);
        see.m35040a(parcel, 3, this.f110186c, i, false);
        see.m35052a(parcel, 4, this.f110187d, false);
