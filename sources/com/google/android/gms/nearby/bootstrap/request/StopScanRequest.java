...
public class StopScanRequest extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new ahes();

    /* renamed from: a */
    final int f80437a;

    /* renamed from: b */
    public final ahdp f80438b;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        see.m35063b(parcel, 1000, this.f80437a);
        see.m35062b(parcel, a);
    }

    public StopScanRequest(ahdp ahdp) {
        this.f80437a = 1;
        sdo.m34959a(ahdp);
        this.f80438b = ahdp;
    }
