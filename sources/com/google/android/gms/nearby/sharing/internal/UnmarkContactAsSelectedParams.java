...
public final class UnmarkContactAsSelectedParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new akbl();

    /* renamed from: a */
    public Contact f81132a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof UnmarkContactAsSelectedParams) {
            ...
            return sdg.m34949a(this.f81132a, unmarkContactAsSelectedParams.f81132a) && sdg.m34949a(this.f81133b, unmarkContactAsSelectedParams.f81133b);
        }
    }

    public final int hashCode() {
        return Arrays.hashCode(new Object[]{this.f81132a, this.f81133b});
    }
    ...
    public UnmarkContactAsSelectedParams(Contact contact, IBinder iBinder) {
        ...
        this.f81132a = contact;
        this.f81133b = rnt;
    }

    public final void writeToParcel(Parcel parcel, int i) {
        int a = see.m35030a(parcel);
        see.m35040a(parcel, 1, this.f81132a, i, false);
        see.m35038a(parcel, 2, this.f81133b.asBinder());
