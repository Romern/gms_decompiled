...
public final class ProtoSafeParcelable extends AbstractSafeParcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ProtoSafeParcelable) {
            return Arrays.equals(this.f81567a, ((ProtoSafeParcelable) obj).f81567a);
        }
        return false;
    }

    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Integer.valueOf(Arrays.hashCode(this.f81567a))});
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        see.m35052a(parcel, 1, this.f81567a, false);
