...
public final class GetAttestationSignalRequest extends AbstractSafeParcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof GetAttestationSignalRequest) {
            ...
            return sdg.m34949a(this.f81474a, getAttestationSignalRequest.f81474a) && sdg.m34949a(this.f81475b, getAttestationSignalRequest.f81475b);
        }
    }

    public final int hashCode() {
        return Arrays.hashCode(new Object[]{this.f81474a, this.f81475b});
    }

    public GetAttestationSignalRequest(Account account, String str) {
        this.f81474a = account;
        this.f81475b = str;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        see.m35040a(parcel, 1, this.f81474a, i, false);
        see.m35046a(parcel, 2, this.f81475b, false);
