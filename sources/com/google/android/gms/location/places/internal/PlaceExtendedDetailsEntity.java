...
public class PlaceExtendedDetailsEntity extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new aeod();

    /* renamed from: a */
    public final List f79553a;
    ...
    public PlaceExtendedDetailsEntity(List list, String str, Uri uri, float f, int i) {
        this.f79553a = Collections.unmodifiableList(list);
        this.f79554b = str;
        this.f79555c = uri;
        this.f79556d = f;
        this.f79557e = i;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        see.m35049a(parcel, 1, this.f79553a, false);
        see.m35046a(parcel, 2, this.f79554b, false);
        see.m35040a(parcel, 3, this.f79555c, i, false);
        see.m35034a(parcel, 4, this.f79556d);
        see.m35063b(parcel, 5, this.f79557e);
