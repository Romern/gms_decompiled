...
final class OpenSSLECGroupContext {
    ...
    static OpenSSLECGroupContext getInstance(ECParameterSpec eCParameterSpec) {
        ...
        if (field instanceof ECFieldFp) {
            ...
            String valueOf = String.valueOf(field.getClass().getName());
            throw new InvalidParameterException(valueOf.length() == 0 ? new String("unhandled field class ") : "unhandled field class ".concat(valueOf));
        }
    }
