...
public final class NativeCrypto {
    ...
    private static final Set SUPPORTED_LEGACY_CIPHER_SUITES_SET = new HashSet();
    private static final String[] SUPPORTED_PROTOCOLS = {SUPPORTED_PROTOCOL_TLSV1, SUPPORTED_PROTOCOL_TLSV1_1, SUPPORTED_PROTOCOL_TLSV1_2, SUPPORTED_PROTOCOL_TLSV1_3};
    ...
    static final Set SUPPORTED_TLS_1_2_CIPHER_SUITES_SET = new HashSet();
    static final String[] SUPPORTED_TLS_1_3_CIPHER_SUITES = {"TLS_AES_128_GCM_SHA256", "TLS_AES_256_GCM_SHA384", "TLS_CHACHA20_POLY1305_SHA256"};
    static final Set SUPPORTED_TLS_1_3_CIPHER_SUITES_SET = new HashSet(Arrays.asList(SUPPORTED_TLS_1_3_CIPHER_SUITES));
    ...
    static {
        ...
        if (loadError == null) {
            ...
            if ((length & 1) == 0) {
                ...
                for (int i2 = 0; i2 < length; i2 += 2) {
                    String cipherSuiteToJava = cipherSuiteToJava(strArr[i2]);
                    SUPPORTED_TLS_1_2_CIPHER_SUITES[i2 / 2] = cipherSuiteToJava;
                    SUPPORTED_TLS_1_2_CIPHER_SUITES_SET.add(cipherSuiteToJava);
                    SUPPORTED_LEGACY_CIPHER_SUITES_SET.add(strArr[i2 + 1]);
                }
                String[] strArr2 = SUPPORTED_TLS_1_2_CIPHER_SUITES;
        ...
        String[] strArr3 = {SUPPORTED_PROTOCOL_TLSV1, SUPPORTED_PROTOCOL_TLSV1_1, SUPPORTED_PROTOCOL_TLSV1_2, SUPPORTED_PROTOCOL_TLSV1_3};
        TLSV13_PROTOCOLS = strArr3;
        String[] strArr4 = {SUPPORTED_PROTOCOL_TLSV1, SUPPORTED_PROTOCOL_TLSV1_1, SUPPORTED_PROTOCOL_TLSV1_2};
        TLSV12_PROTOCOLS = strArr4;
        TLSV11_PROTOCOLS = strArr4;
        TLSV1_PROTOCOLS = strArr4;
        DEFAULT_PROTOCOLS = strArr3;
    }
    ...
    static native int ENGINE_SSL_read_BIO_heap(long j, NativeSsl nativeSsl, long j2, byte[] bArr, int i, int i2, SSLHandshakeCallbacks sSLHandshakeCallbacks);
    ...
    static native int ENGINE_SSL_write_BIO_heap(long j, NativeSsl nativeSsl, long j2, byte[] bArr, int i, int i2, SSLHandshakeCallbacks sSLHandshakeCallbacks);
    ...
    static String[] checkEnabledCipherSuites(String[] strArr) {
        if (strArr != null) {
            ...
            while (i < strArr.length) {
                ...
                } else if (!str.equals(TLS_EMPTY_RENEGOTIATION_INFO_SCSV) && !strArr[i].equals(TLS_FALLBACK_SCSV) && !SUPPORTED_TLS_1_2_CIPHER_SUITES_SET.contains(strArr[i]) && !SUPPORTED_LEGACY_CIPHER_SUITES_SET.contains(strArr[i])) {
    ...
    static String[] checkEnabledProtocols(String[] strArr) {
        if (strArr != null) {
            ...
            while (i < length) {
                ...
                } else if (!str.equals(SUPPORTED_PROTOCOL_TLSV1) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_1) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_2) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_3) && !str.equals(OBSOLETE_PROTOCOL_SSLV3)) {
    ...
    private static int getProtocolConstant(String str) {
        ...
        throw new AssertionError(valueOf.length() == 0 ? new String("Unknown protocol encountered: ") : "Unknown protocol encountered: ".concat(valueOf));
    }
    ...
    static native void setApplicationProtocolSelector(long j, NativeSsl nativeSsl, ApplicationProtocolSelectorAdapter applicationProtocolSelectorAdapter);
