...
public class ActivateDeviceAdminUponUnlockChimeraReceiver extends IntentOperation {
    ...
    /* renamed from: a */
    private static boolean f80049a;

    /* renamed from: a */
    public static synchronized void m67194a(boolean z) {
    ...
    /* renamed from: a */
    public static synchronized boolean m67195a() {
        boolean z;
        synchronized (ActivateDeviceAdminUponUnlockChimeraReceiver.class) {
            z = f80049a;
        }
    ...
    public final void onHandleIntent(Intent intent) {
        if (m67195a() && "android.intent.action.USER_PRESENT".equals(intent.getAction())) {
