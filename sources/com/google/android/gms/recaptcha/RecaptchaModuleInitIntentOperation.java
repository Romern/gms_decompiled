...
public class RecaptchaModuleInitIntentOperation extends qlf {
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: spn.a(android.content.Context, java.lang.String, boolean):void
     arg types: [com.google.android.gms.recaptcha.RecaptchaModuleInitIntentOperation, java.lang.String, int]
     candidates:
    ...
    public final void mo6344a(Intent intent, int i) {
        int i2 = i & 8;
        if ((i & 4) != 0 || i2 != 0) {
            spn.m35856a((Context) this, "com.google.android.gms.recaptcha.RecaptchaActivity", true);
        }
    }
}
