...
public final class ycm extends yct {
    /* access modifiers changed from: protected */
    /* renamed from: a */
    public final View mo30349a(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        return layoutInflater.inflate((int) C0126R.C0128layout.ble_processing_fragment, viewGroup, z);
    }
    ...
    public final void onResume() {
        super.onResume();
        getActivity().setTitle(getString(C0126R.string.fido_processing));
        getActivity().getWindow().getDecorView().sendAccessibilityEvent(32);
    }

    /* renamed from: a */
    public final ycu mo30350a() {
        return ycu.BLE_PROCESSING_FRAGMENT;
    }
}
