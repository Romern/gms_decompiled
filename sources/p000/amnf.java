...
public final class amnf extends bxvk implements bxxd {
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return bxvk.m124022a(f75449e, "\u0001\u0003\u0000\u0001\u0001\u0003\u0003\u0000\u0001\u0000\u0001င\u0000\u0002ဈ\u0001\u0003\u001b", new Object[]{"a", "b", "c", "d", amne.class});
        } else if (i2 == 3) {
            return new amnf();
        } else {
            if (i2 == 4) {
    ...
    public final void mo41221a() {
        if (!this.f75454d.mo73666a()) {
            this.f75454d = bxvk.m124021a(this.f75454d);
        }
    }
}
