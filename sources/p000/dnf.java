...
public final class dnf extends brtm {

    /* renamed from: a */
    public static final /* synthetic */ int f13620a = 0;

    /* renamed from: a */
    public static dnf m8867a(dnf dnf, int i, String str, ByteBuffer byteBuffer) {
        ...
        while (i2 != 0) {
            ...
            if (compareStrings > 0) {
                ...
                dnf.__reset(__indirect, byteBuffer);
                return dnf;
            }
        }
        return null;
