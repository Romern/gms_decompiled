...
public final class beaj {
    ...
    static Map m91665a() {
        ...
        arrayList47.add("SS");
        hashMap.put(Integer.valueOf((int) BaseMfiEventCallback.TYPE_CARD_NOT_ACTIVE), arrayList47);
        ArrayList arrayList48 = new ArrayList(2);
        arrayList48.add("MA");
        arrayList48.add("EH");
        hashMap.put(Integer.valueOf((int) BaseMfiEventCallback.TYPE_EXIST_UNKNOWN_CARD), arrayList48);
        ArrayList arrayList49 = new ArrayList(1);
        arrayList49.add("DZ");
        hashMap.put(Integer.valueOf((int) BaseMfiEventCallback.TYPE_ISSUE_LIMIT_EXCEEDED), arrayList49);
        ArrayList arrayList50 = new ArrayList(1);
        arrayList50.add("TN");
        hashMap.put(Integer.valueOf((int) BaseMfiEventCallback.TYPE_OPSRV_ACCOUNT_ERROR), arrayList50);
        ArrayList arrayList51 = new ArrayList(1);
        arrayList51.add("LY");
        hashMap.put(Integer.valueOf((int) BaseMfiEventCallback.TYPE_AGREEMENT_NOT_ACCEPT), arrayList51);
        ...
        arrayList56.add("GN");
        hashMap.put(Integer.valueOf((int) AndroidInputTypeSignal.TYPE_TEXT_VARIATION_WEB_PASSWORD), arrayList56);
        ...
        arrayList88.add("UG");
        hashMap.put(Integer.valueOf((int) PSKKeyManager.MAX_KEY_LENGTH_BYTES), arrayList88);
        ...
        arrayList105.add("GL");
        hashMap.put(Integer.valueOf((int) ErrorInfo.TYPE_ACTIVATE_FELICA_UNKNOWN_ERROR), arrayList105);
