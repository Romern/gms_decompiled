...
public final class bmsy extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bmsy bmsy = new bmsy();
        f130790d = bmsy;
        GeneratedMessageLite.m124024a(bmsy.class, bmsy);
    }
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return GeneratedMessageLite.m124022a(f130790d, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\t\u0002\t\u0003\t", new Object[]{"a", "b", "c"});
        } else if (i2 == 3) {
            return new bmsy();
        } else {
            if (i2 == 4) {
