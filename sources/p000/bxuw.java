...
public final class bxuw extends bxvk implements bxxd {
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return bxvk.m124022a(f164878b, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0001\u0000\u0001Ț", new Object[]{"a"});
        } else if (i2 == 3) {
            return new bxuw();
        } else {
            if (i2 == 4) {
    ...
    public final void mo73907c() {
        if (!this.f164880a.mo73666a()) {
            this.f164880a = bxvk.m124021a(this.f164880a);
        }
    }
}
