...
public final class ammd extends GeneratedMessageLite implements bxxd {
    ...
    static {
        ammd ammd = new ammd();
        f75264l = ammd;
        GeneratedMessageLite.m124024a(ammd.class, ammd);
    }
