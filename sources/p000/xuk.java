...
final class xuk implements xoo {

    /* renamed from: a */
    final /* synthetic */ xok f53165a;
    ...
    public final void mo14259a(AuthenticatorErrorResponse authenticatorErrorResponse) {
        try {
            this.f53165a.mo29968a(authenticatorErrorResponse);
        } catch (RemoteException e) {
    ...
    public final void mo14260a(PublicKeyCredential publicKeyCredential) {
        try {
            this.f53165a.mo29969a(publicKeyCredential);
        } catch (RemoteException e) {
