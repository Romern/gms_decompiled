...
public final class bmmv extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bmmv bmmv = new bmmv();
        f130053f = bmmv;
        GeneratedMessageLite.m124024a(bmmv.class, bmmv);
    }
