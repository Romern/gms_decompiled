...
public final class btay extends GeneratedMessageLite implements bxxd {
    ...
    static {
        btay btay = new btay();
        f148056p = btay;
        GeneratedMessageLite.m124024a(btay.class, btay);
    }
