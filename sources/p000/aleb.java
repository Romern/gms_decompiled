...
public final class aleb implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < b) {
            ...
            if (a == 1) {
                payGlobalActionCardArr = (PayGlobalActionCard[]) sed.m35004b(parcel, readInt, PayGlobalActionCard.CREATOR);
            } else if (a != 2) {
