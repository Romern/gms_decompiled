...
public final class bpma extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bpma bpma = new bpma();
        f138193p = bpma;
        GeneratedMessageLite.m124024a(bpma.class, bpma);
    }
