...
public final class brch extends GeneratedMessageLite implements bxxd {
    ...
    static {
        brch brch = new brch();
        f142366k = brch;
        GeneratedMessageLite.m124024a(brch.class, brch);
    }
