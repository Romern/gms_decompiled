...
final class arxm implements ardt {
    ...
    public final void mo48217a() {
        if (!this.f88413b) {
            ...
            Logger.mo25416d(String.format("Scan timed out while searching for device: %s, %s", d2DDevice.f107875d, d2DDevice.f107874c), new Object[0]);
    ...
    public final void mo48218a(int i) {
        ...
        Logger.mo25418e(valueOf.length() == 0 ? new String("Error: ") : "Error: ".concat(valueOf), new Object[0]);
        this.f88412a.f88431b.mo48908c(5);
    }

    /* renamed from: a */
    public final void mo48219a(D2DDevice d2DDevice) {
        arxy.f88430a.logVerbose(String.format("Found device: %s, %s", d2DDevice.f107875d, d2DDevice.f107874c), new Object[0]);
