...
public final class bmki extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bmki bmki = new bmki();
        f129802w = bmki;
        GeneratedMessageLite.m124024a(bmki.class, bmki);
    }
