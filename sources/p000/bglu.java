...
public final class bglu implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < b) {
            ...
            if (a == 1) {
                userLocationNearbyAlertRequest = (UserLocationNearbyAlertRequest) sed.m34998a(parcel, readInt, UserLocationNearbyAlertRequest.CREATOR);
            } else if (a == 2) {
