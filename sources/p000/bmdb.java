...
public final class bmdb extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bmdb bmdb = new bmdb();
        f128767k = bmdb;
        GeneratedMessageLite.m124024a(bmdb.class, bmdb);
    }
