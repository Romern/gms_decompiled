...
public final class bwsp extends bxvk implements bxxd {
    ...
    static {
        bwsp bwsp = new bwsp();
        f160899c = bwsp;
        bxvk.m124024a(bwsp.class, bwsp);
        bwog bwog = bwog.f160437f;
        bwsp bwsp2 = f160899c;
        f160900d = bxvk.m124006a(bwog, bwsp2, bwsp2, 209031767, bxzf.MESSAGE);
    }
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return bxvk.m124022a(f160899c, "\u0001\u0001\u0000\u0001\u0001\u0001\u0001\u0000\u0000\u0000\u0001ဈ\u0000", new Object[]{"a", "b"});
        } else if (i2 == 3) {
            return new bwsp();
        } else {
            if (i2 == 4) {
