...
public final class brdk extends GeneratedMessageLite implements bxxd {
    ...
    static {
        brdk brdk = new brdk();
        f142515l = brdk;
        GeneratedMessageLite.m124024a(brdk.class, brdk);
    }
