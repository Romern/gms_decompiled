...
/* renamed from: tby */
final /* synthetic */ class tby implements aubw {

    /* renamed from: a */
    private final ConstellationDebugChimeraActivity f45627a;

    public tby(ConstellationDebugChimeraActivity constellationDebugChimeraActivity) {
        this.f45627a = constellationDebugChimeraActivity;
    }

    /* renamed from: a */
    public final void mo10462a(Object obj) {
        ConstellationDebugChimeraActivity constellationDebugChimeraActivity = this.f45627a;
        List<PhoneNumberInfo> list = (List) obj;
        constellationDebugChimeraActivity.mo17988a(true);
        ConstellationDebugChimeraActivity.f30575b.mo25412b("Successfully call One Time Verification API.", new Object[0]);
        ((TextView) constellationDebugChimeraActivity.findViewById(C0126R.C0129id.summary)).setText(String.format(Locale.US, "Successfully verify phone number via One Time Verification API.", new Object[0]));
