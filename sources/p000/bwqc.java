...
public final class bwqc extends bxvk implements bxxd {
    ...
    static {
        bwqc bwqc = new bwqc();
        f160636b = bwqc;
        bxvk.m124024a(bwqc.class, bwqc);
        bwny bwny = bwny.f160414k;
        bwqc bwqc2 = f160636b;
        f160637c = bxvk.m124006a(bwny, bwqc2, bwqc2, 275110909, bxzf.MESSAGE);
    }
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return bxvk.m124022a(f160636b, "\u0001\u0001\u0000\u0000\u0002\u0002\u0001\u0000\u0001\u0000\u0002\u001b", new Object[]{"a", bwpz.class});
        } else if (i2 == 3) {
            return new bwqc();
        } else {
            if (i2 == 4) {
