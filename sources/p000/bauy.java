...
public final class bauy extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bauy bauy = new bauy();
        f101847l = bauy;
        GeneratedMessageLite.m124024a(bauy.class, bauy);
    }
