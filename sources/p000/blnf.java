...
public final class blnf extends GeneratedMessageLite implements bxxd {
    ...
    static {
        blnf blnf = new blnf();
        f126936z = blnf;
        GeneratedMessageLite.m124024a(blnf.class, blnf);
    }
    ...
    public final void mo66686a() {
        if (!this.f126955r.mo73666a()) {
            this.f126955r = GeneratedMessageLite.m124021a(this.f126955r);
        }
    }
}
