...
public enum catq {
    ...
    /* renamed from: aS */
    final String f175954aS;

    private catq(String str) {
        this.f175954aS = str;
    }

    /* renamed from: b */
    public static catq m127184b(String str) {
        if (!str.startsWith("SSL_")) {
            return m127183a(str);
        }
        String valueOf = String.valueOf(str.substring(4));
        return m127183a(valueOf.length() == 0 ? new String("TLS_") : "TLS_".concat(valueOf));
    }
}
