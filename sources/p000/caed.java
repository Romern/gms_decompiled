...
public final class caed extends GeneratedMessageLite implements bxxd {
    ...
    /* renamed from: g */
    public ByteString f172807g = ByteString.f164797b;
    ...
    static {
        caed caed = new caed();
        f172799i = caed;
        GeneratedMessageLite.m124024a(caed.class, caed);
    }
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return GeneratedMessageLite.m124022a(f172799i, "\u0001\u0007\u0000\u0001\u0001\u0007\u0007\u0000\u0005\u0000\u0001ဈ\u0000\u0002\u0019\u0003\u0014\u0004\u001a\u0005\u001b\u0006ည\u0001\u0007\u0012", new Object[]{"a", "b", "c", "d", "e", "f", caef.class, "g", "h"});
        } else if (i2 == 3) {
            return new caed();
        } else {
            if (i2 == 4) {
    ...
    public final void mo74627c() {
        if (!this.f172803c.mo73666a()) {
            this.f172803c = GeneratedMessageLite.m124017a(this.f172803c);
        }
    }
    ...
    public final void mo74628e() {
        if (!this.f172804d.mo73666a()) {
            this.f172804d = GeneratedMessageLite.m124020a(this.f172804d);
        }
    }
    ...
    public final void mo74629f() {
        if (!this.f172805e.mo73666a()) {
            this.f172805e = GeneratedMessageLite.m124021a(this.f172805e);
        }
    }
