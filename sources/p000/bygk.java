...
public final class bygk extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bygk bygk = new bygk();
        f166327s = bygk;
        GeneratedMessageLite.m124024a(bygk.class, bygk);
    }
