...
public final /* synthetic */ class mej implements Runnable {
    ...
    public final void run() {
        ...
        int i = mgj.f33632j;
        if (i == 0) {
            mgj.f33623a.logVerbose("Expected state: AUTHORIZATION_REQUESTED, reported state: INITIAL. Changing state to AWAITING_USB.", new Object[0]);
            mgj.f33632j = 5;
            mgj.mo19985b();
        } else if (i == 3) {
            mgj.f33632j = 4;
            ...
            mgj.f33623a.logVerbose("proceedAfterScreenUnlock was called after the cable was unplugged, not proceeding with authorization.", new Object[0]);
        }
    }
}
