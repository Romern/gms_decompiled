...
public final class avxm extends sbm {
    /* renamed from: I */
    ...
    public final /* bridge */ /* synthetic */ IInterface mo6462a(IBinder iBinder) {
        ...
        if (queryLocalInterface instanceof avxk) {
            return (avxk) queryLocalInterface;
        }
        return new avxi(iBinder);
    }
    ...
    public avxm(Context context, Looper looper, sat sat, rjz rjz, rka rka) {
        super(context, looper, 163, sat, rjz, rka);
    }
}
