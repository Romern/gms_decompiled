...
public final class bqpe extends bqnr {
    public bqpe() {
        super(bqrf.class, new bqpc(bqng.class));
    }
    ...
    public final /* bridge */ /* synthetic */ bxxc mo69297a(ByteString bxtx) {
        ...
        bqrf bqrf = bqrf.f141429c;
        try {
            bxuc h = bxtx.mo73764h();
            GeneratedMessageLite GeneratedMessageLite = (GeneratedMessageLite) bqrf.mo74142c(4);
            ...
            return (bqrf) GeneratedMessageLite;
        } catch (IOException e) {
    ...
    public final /* bridge */ /* synthetic */ void mo69300a(bxxc bxxc) {
        bqrf bqrf = (bqrf) bxxc;
        bqwl.m113528c(bqrf.f141431a);
        if (bqrf.f141432b.mo73744a() != 32) {
