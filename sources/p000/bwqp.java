...
public final class bwqp extends bxvk implements bxxd {
    ...
    static {
        bwqp bwqp = new bwqp();
        f160701c = bwqp;
        bxvk.m124024a(bwqp.class, bwqp);
        bwog bwog = bwog.f160437f;
        bwqp bwqp2 = f160701c;
        f160702d = bxvk.m124006a(bwog, bwqp2, bwqp2, 290848975, bxzf.MESSAGE);
    }
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return bxvk.m124022a(f160701c, "\u0001\u0001\u0000\u0001\u0001\u0001\u0001\u0000\u0000\u0000\u0001ဈ\u0000", new Object[]{"a", "b"});
        } else if (i2 == 3) {
            return new bwqp();
        } else {
            if (i2 == 4) {
