...
public final class bwqj extends bxvk implements bxxd {
    ...
    static {
        bwqj bwqj = new bwqj();
        f160665d = bwqj;
        bxvk.m124024a(bwqj.class, bwqj);
        bwoq bwoq = bwoq.f160480d;
        bwqj bwqj2 = f160665d;
        f160666e = bxvk.m124006a(bwoq, bwqj2, bwqj2, 279356603, bxzf.MESSAGE);
    }
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return bxvk.m124022a(f160665d, "\u0001\u0002\u0001\u0001\u0001\u0002\u0002\u0000\u0000\u0000\u0001ဌ\u0000\u0002ြ\u0000", new Object[]{"b", "a", "f", "c", bwqh.f160664a, bwql.class});
        } else if (i2 == 3) {
            return new bwqj();
        } else {
            if (i2 == 4) {
