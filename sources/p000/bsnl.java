...
public final class bsnl extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bsnl bsnl = new bsnl();
        f146266C = bsnl;
        GeneratedMessageLite.m124024a(bsnl.class, bsnl);
    }
