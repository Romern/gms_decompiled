...
public final class bpmc extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bpmc bpmc = new bpmc();
        f138211m = bpmc;
        GeneratedMessageLite.m124024a(bpmc.class, bpmc);
    }
