...
public final class auhc extends bxvk implements bxxd {
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return bxvk.m124022a(f91805d, "\u0001\u0002\u0000\u0001\u0001\u0002\u0002\u0000\u0001\u0000\u0001ဇ\u0000\u0002\u001a", new Object[]{"a", "b", "c"});
        } else if (i2 == 3) {
            return new auhc();
        } else {
            if (i2 == 4) {
    ...
    public final void mo50522a() {
        if (!this.f91809c.mo73666a()) {
            this.f91809c = bxvk.m124021a(this.f91809c);
        }
    }
}
