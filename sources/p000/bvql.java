...
public final class bvql extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bvql bvql = new bvql();
        f157381l = bvql;
        GeneratedMessageLite.m124024a(bvql.class, bvql);
    }
