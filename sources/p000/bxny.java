...
public final class bxny extends bxvk implements bxxd {
    ...
    static {
        bxny bxny = new bxny();
        f164115k = bxny;
        bxvk.m124024a(bxny.class, bxny);
        bxcf bxcf = bxcf.f162779a;
        bxny bxny2 = f164115k;
        f164116l = bxvk.m124006a(bxcf, bxny2, bxny2, 157164189, bxzf.MESSAGE);
    }
