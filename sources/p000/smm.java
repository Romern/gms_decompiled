...
public final class smm extends smk implements RadiosTracingLoggerProvider.NetworkActivityLogger {

    /* renamed from: c */
    private static final sqh f44767c = sml.f44766a;
    ...
    public smm(NetworkActivityDbHelper networkActivityDbHelper, ScheduledExecutorService scheduledExecutorService, long j, TimeUnit timeUnit, int i) {
        super(networkActivityDbHelper, NetworkActivityContract.NetworkActivityColumns.TABLE_NAME, f44767c, scheduledExecutorService, j, timeUnit, i);
    }
    ...
    public final List getEvents(long j, long j2, int i, int i2, int i3, int i4) {
        ...
        try {
            a = this.f44765b.mo25970a(NetworkActivityContract.NetworkActivityColumns.TABLE_NAME, strArr, "network_type = ? AND tag = ? AND device_state = ? AND event_time_ms BETWEEN ? AND ?", strArr2, "event_time_ms ASC", str);
            if (a != null) {
                int columnIndexOrThrow = a.getColumnIndexOrThrow("event_time_ms");
                int columnIndexOrThrow2 = a.getColumnIndexOrThrow("network_type");
                int columnIndexOrThrow3 = a.getColumnIndexOrThrow("tag");
