...
public final class btjc extends GeneratedMessageLite implements bxxd {
    ...
    static {
        btjc btjc = new btjc();
        f149080s = btjc;
        GeneratedMessageLite.m124024a(btjc.class, btjc);
    }
