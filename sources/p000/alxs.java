...
public final class alxs implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == b) {
            return new PersonImpl.AddressesImpl(hashSet, metadataImpl, str, str2, str3, str4, str5, str6, str7, str8, str9, str10);
        }
