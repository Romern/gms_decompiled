...
public final class aapc extends bxvk implements bxxd {
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return bxvk.m124022a(f28738b, "\u0001\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0001\u0000\u0001\u001b", new Object[]{"a", aapb.class});
        } else if (i2 == 3) {
            return new aapc();
        } else {
            if (i2 == 4) {
    ...
    public final void mo17179a() {
        if (!this.f28740a.mo73666a()) {
            this.f28740a = bxvk.m124021a(this.f28740a);
        }
    }
}
