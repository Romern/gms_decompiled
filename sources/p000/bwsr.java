...
public final class bwsr extends bxvk implements bxxd {
    ...
    static {
        bwsr bwsr = new bwsr();
        f160910b = bwsr;
        bxvk.m124024a(bwsr.class, bwsr);
        bwny bwny = bwny.f160414k;
        bwsr bwsr2 = f160910b;
        f160911c = bxvk.m124006a(bwny, bwsr2, bwsr2, 297159458, bxzf.MESSAGE);
    }
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return bxvk.m124022a(f160910b, "\u0001\u0001\u0000\u0001\u0001\u0001\u0001\u0000\u0000\u0000\u0001င\u0000", new Object[]{"d", "a"});
        } else if (i2 == 3) {
            return new bwsr();
        } else {
            if (i2 == 4) {
