...
public final class bpvm extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bpvm bpvm = new bpvm();
        f139376l = bpvm;
        GeneratedMessageLite.m124024a(bpvm.class, bpvm);
    }
