...
public final class qnx extends GeneratedMessageLite implements bxxd {
    ...
    static {
        qnx qnx = new qnx();
        f41814d = qnx;
        GeneratedMessageLite.m124024a(qnx.class, qnx);
    }
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return GeneratedMessageLite.m124022a(f41814d, "\u0001\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0003\u0000\u0001\u001c\u0002\u001c\u0003\u001c", new Object[]{"a", "b", "c"});
        } else if (i2 == 3) {
            return new qnx();
        } else {
            if (i2 == 4) {
    ...
    public final void mo24146b() {
        if (!this.f41817b.mo73666a()) {
            this.f41817b = GeneratedMessageLite.m124021a(this.f41817b);
        }
    }
    ...
    public final void mo24147c() {
        if (!this.f41818c.mo73666a()) {
            this.f41818c = GeneratedMessageLite.m124021a(this.f41818c);
        }
    }
    ...
    public final void mo24145a() {
        if (!this.f41816a.mo73666a()) {
            this.f41816a = GeneratedMessageLite.m124021a(this.f41816a);
        }
    }
}
