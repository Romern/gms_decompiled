...
public final class bodd extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bodd bodd = new bodd();
        f132660m = bodd;
        GeneratedMessageLite.m124024a(bodd.class, bodd);
    }
