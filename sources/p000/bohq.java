...
public final class bohq extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bohq bohq = new bohq();
        f133128l = bohq;
        GeneratedMessageLite.m124024a(bohq.class, bohq);
    }
