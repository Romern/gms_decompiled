...
public final class qhg extends bxvk implements bxxd {
    ...
    public final void mo24050a() {
        if (!this.f41350m.mo73666a()) {
            this.f41350m = bxvk.m124021a(this.f41350m);
        }
    }
}
