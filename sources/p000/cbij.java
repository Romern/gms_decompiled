...
public final class cbij extends bxvk implements bxxd {
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return bxvk.m124022a(f177251e, "\u0000\u0004\u0000\u0000\u0001\u0004\u0004\u0000\u0001\u0000\u0001\u001b\u0002\t\u0003\t\u0004\t", new Object[]{"a", cbil.class, "b", "c", "d"});
        } else if (i2 == 3) {
            return new cbij();
        } else {
            if (i2 == 4) {
    ...
    public final void mo75235c() {
        if (!this.f177253a.mo73666a()) {
            this.f177253a = bxvk.m124021a(this.f177253a);
        }
    }
}
