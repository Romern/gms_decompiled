...
public final class caig extends bxvk implements bxxd {
    ...
    public final void mo74651c() {
        if (!this.f174692j.mo73666a()) {
            this.f174692j = bxvk.m124021a(this.f174692j);
        }
    }
}
