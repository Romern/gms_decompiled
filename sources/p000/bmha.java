...
public final class bmha extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bmha bmha = new bmha();
        f129377k = bmha;
        GeneratedMessageLite.m124024a(bmha.class, bmha);
    }
