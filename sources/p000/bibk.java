...
public final class bibk extends bibd {
    /* renamed from: a */
    ...
    public bibk(sgv sgv, Context context, ClientContext clientContext, String str, PlacesParams placesParams) {
        super(sgv, clientContext, str, ((bvma) r0.mo74062i()).serializeToBytes(), bvmb.f156630c, 5, 10273);
        ...
        bvma.f156628b = a;
        bvma.f156627a |= 1;
        bvlz.mo73381a(bvkz.INFERRED_HOME);
        bvlz.mo73381a(bvkz.INFERRED_WORK);
    }
}
