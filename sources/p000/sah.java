...
public final class sah extends scj {
    ...
    public final void mo16678a(int i, IBinder iBinder, Bundle bundle) {
        sdo.m34966a(this.f43920a, "onPostInitComplete can be called only once per call to getRemoteService");
    ...
    public final void mo16679a(int i, IBinder iBinder, ConnectionInfo connectionInfo) {
        sdo.m34966a(this.f43920a, "onPostInitCompleteWithConnectionInfo can be called only once per call togetRemoteService");
