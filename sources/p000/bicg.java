...
public final class bicg extends bick {

    /* renamed from: a */
    private final bibt f120202a;

    /* renamed from: b */
    private final ClientContext f120203b;

    /* renamed from: c */
    private final String f120204c;

    public bicg(bibt bibt, ClientContext clientContext, String str) {
        this.f120202a = bibt;
        this.f120203b = clientContext;
        this.f120204c = str;
    }
    ...
    public final /* bridge */ /* synthetic */ Object mo64518a() {
        bibt bibt = this.f120202a;
        ClientContext clientContext = this.f120203b;
        String str = this.f120204c;
        ...
        bvtv.f157623a |= 1;
        bvtv.f157624b = str;
        bvtu.mo73386a(bvuc.CONFIRMED_HOME);
        bvtu.mo73386a(bvuc.CONFIRMED_WORK);
