...
public final class byat extends GeneratedMessageLite implements bxxd {
    ...
    static {
        byat byat = new byat();
        f165321l = byat;
        GeneratedMessageLite.m124024a(byat.class, byat);
    }
