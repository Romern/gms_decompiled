...
public final class agnk extends bxvk implements bxxd {
    ...
    public final Object mo3216a(int i, Object obj) {
        ...
        if (i2 == 2) {
            return bxvk.m124022a(f66077g, "\u0001\u0005\u0000\u0001\u0001\u0006\u0005\u0000\u0001\u0000\u0001ဈ\u0000\u0002ဈ\u0001\u0003ဂ\u0002\u0005က\u0004\u0006\u001b", new Object[]{"a", "b", "c", "d", "e", "f", agnk.class});
        } else if (i2 == 3) {
            return new agnk();
        } else {
            if (i2 == 4) {
    ...
    public final void mo35757a() {
        if (!this.f66084f.mo73666a()) {
            this.f66084f = bxvk.m124021a(this.f66084f);
        }
    }
}
