...
public final class apcd implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < b) {
            ...
            if (a == 2) {
                ...
                arrayList = sed.m35005c(parcel, readInt, EmailAddressEntity.CREATOR);
            } else if (a != 5) {
                sed.m35002b(parcel, readInt);
            } else {
                arrayList2 = sed.m35005c(parcel, readInt, PhoneNumberEntity.CREATOR);
            }
        }
