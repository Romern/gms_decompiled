...
final class bqpg extends bqnp {
    ...
    public final /* bridge */ /* synthetic */ Object mo69295b(bxxc bxxc) {
        bqsn bqsn = (bqsn) bxxc;
        bxvd da = bqsm.f141545c.mo74144da();
        if (da.f164950c) {
            da.mo74035c();
            da.f164950c = false;
        }
        bqsm bqsm = (bqsm) da.f164949b;
        bqsn.getClass();
        bqsm.f141548b = bqsn;
        bqsm.f141547a = 0;
        return (bqsm) da.mo74062i();
    }

    /* renamed from: a */
    public final /* bridge */ /* synthetic */ bxxc mo69293a(ByteString bxtx) {
        bxus b = bxus.m123743b();
        bqsn bqsn = bqsn.f141549b;
        try {
            bxuc h = bxtx.mo73764h();
            GeneratedMessageLite GeneratedMessageLite = (GeneratedMessageLite) bqsn.mo74142c(4);
            ...
            return (bqsn) GeneratedMessageLite;
        } catch (IOException e) {
