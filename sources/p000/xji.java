...
public final class xji {
    ...
    public xji(int i, xjf xjf) {
        this.f52415d = i;
        this.f52414c = new xjj(i);
        this.f52413b = xjf;
    }

    /* renamed from: a */
    public final boolean mo29837a() {
        xjj xjj = this.f52414c;
        return xjj.f52417a == -125 && xjj.mo29838a();
    }
}
