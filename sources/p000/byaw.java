...
public final class byaw extends GeneratedMessageLite implements bxxd {
    ...
    static {
        byaw byaw = new byaw();
        f165345u = byaw;
        GeneratedMessageLite.m124024a(byaw.class, byaw);
    }
