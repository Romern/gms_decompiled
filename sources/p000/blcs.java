...
public final class blcs extends GeneratedMessageLite implements bxxd {
    ...
    static {
        blcs blcs = new blcs();
        f125974l = blcs;
        GeneratedMessageLite.m124024a(blcs.class, blcs);
    }
