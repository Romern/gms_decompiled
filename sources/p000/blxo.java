...
public final class blxo extends GeneratedMessageLite implements bxxd {
    ...
    static {
        blxo blxo = new blxo();
        f128095k = blxo;
        GeneratedMessageLite.m124024a(blxo.class, blxo);
    }
