...
final class akhe {
    ...
    /* renamed from: a */
    public static final String f71978a = ("(NOT account_type=com.google.android.exchange) AND (NOT account_type=com.google.exchange) AND (NOT account_type=com.google.android.gm.exchange) AND (NOT account_type=com.google) AND (mimetype=? OR mimetype=?)");

    /* renamed from: b */
    static final String[] f71979b = {"_id", "lookup"};

    /* renamed from: c */
    static final String[] f71980c = {"contact_id", "lookup", "display_name", "photo_thumb_uri", "mimetype", "data1", "data4", "account_name", "account_type", "starred"};

    /* renamed from: d */
    public final Context f71981d;

    public akhe(Context context) {
        this.f71981d = context;
    }

    /* renamed from: a */
    private static ajih m59677a(Cursor cursor, akil akil) {
        Boolean bool;
        ...
        if (columnIndex == -1 || columnIndex2 == -1 || columnIndex3 == -1 || columnIndex4 == -1 || columnIndex5 == -1 || columnIndex6 == -1 || columnIndex7 == -1) {
            ...
            bnsl.mo68432a("akhe", "a", 185, ":com.google.android.gms@201515033@20.15.15 (120300-306758586)");
    ...
    /* renamed from: a */
    private static ajii m59678a(Cursor cursor, Uri uri) {
        if (cursor.getCount() != 1) {
            bnsl bnsl = (bnsl) ajvp.f71371a.mo68388c();
            bnsl.mo68432a("akhe", "a", 122, ":com.google.android.gms@201515033@20.15.15 (120300-306758586)");
        ...
        if (b == null) {
            bnsl bnsl2 = (bnsl) ajvp.f71371a.mo68388c();
            bnsl2.mo68432a("akhe", "a", 128, ":com.google.android.gms@201515033@20.15.15 (120300-306758586)");
        ...
        if (TextUtils.isEmpty(a)) {
            ...
            bnsl3.mo68432a("akhe", "a", 134, ":com.google.android.gms@201515033@20.15.15 (120300-306758586)");
    ...
    public final ajih mo39441a() {
        ...
        int i;
        ajig ajig;
        Cursor a = ahgk.m55688a(this.f71981d, ContactsContract.Data.CONTENT_URI, f71980c, f71978a, new String[]{"vnd.android.cursor.item/phone_v2", "vnd.android.cursor.item/email_v2"}, "contact_id ASC,data1 ASC");
        ...
        if (a != null) {
            try {
                ...
                if (columnIndex == -1) {
                                    ...
                                    while (true) {
                                        ...
                                        if (a5 != null) {
                                            ...
                                            if (TextUtils.isEmpty(a6)) {
                                                ...
                                                str3 = str8;
                                                str4 = str9;
                                                bnsl.mo68432a("akhe", str4, 259, str3);
                    ...
                    bnsl2.mo68432a("akhe", str2, 160, str);
                    bnsl2.mo68409a("Loaded %d third party contacts", ajih.f70709a.size());
                    return ajih;
                }
                bnsl bnsl3 = (bnsl) ajvp.f71371a.mo68388c();
                bnsl3.mo68432a("akhe", str2, 185, str);
                bnsl3.mo68405a("Unable to find the expected columns in the contact content uri.");
                ajih = ajih.f70707b;
                bnsl bnsl22 = (bnsl) ajvp.f71371a.mo68390d();
                bnsl22.mo68432a("akhe", str2, 160, str);
                bnsl22.mo68409a("Loaded %d third party contacts", ajih.f70709a.size());
                return ajih;
            } finally {
                a.close();
            }
            ...
            bnsl4.mo68432a("akhe", str6, (int) MfiClientException.TYPE_MFICLIENT_NOT_STARTED, str5);
            bnsl4.mo68405a("Unable to get cursor for the third party contact content uri.");
            return ajih.f70707b;
        }
    }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      ...
      bnsi.a(java.lang.String, int, java.lang.Object):void */
    /* renamed from: a */
    public final ajii mo39442a(ajii ajii) {
        ...
        Cursor a = ahgk.m55687a(this.f71981d, lookupUri, f71979b);
        if (a != null) {
            try {
                if (a.getCount() != 1) {
                    bnsl bnsl2 = (bnsl) ajvp.f71371a.mo68388c();
                    bnsl2.mo68432a("akhe", "a", 122, ":com.google.android.gms@201515033@20.15.15 (120300-306758586)");
                    bnsl2.mo68413a("Found %d contacts for uri: %s.", a.getCount(), (Object) lookupUri);
                } else {
                    Long b = ahgk.m55693b(a, "_id");
                    if (b == null) {
                        bnsl bnsl3 = (bnsl) ajvp.f71371a.mo68388c();
                        bnsl3.mo68432a("akhe", "a", 128, ":com.google.android.gms@201515033@20.15.15 (120300-306758586)");
                        bnsl3.mo68405a("The contact's id does not exist.");
                    } else {
                        String a2 = ahgk.m55691a(a, "lookup");
                        if (TextUtils.isEmpty(a2)) {
                            bnsl bnsl4 = (bnsl) ajvp.f71371a.mo68388c();
                            bnsl4.mo68432a("akhe", "a", 134, ":com.google.android.gms@201515033@20.15.15 (120300-306758586)");
            ...
            bnsl5.mo68432a("akhe", "a", 108, ":com.google.android.gms@201515033@20.15.15 (120300-306758586)");
