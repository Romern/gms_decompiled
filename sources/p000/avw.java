...
final class avw implements TimeInterpolator {

    /* renamed from: a */
    public static final avw f2397a = new avw();

    /* renamed from: b */
    private static final float[] f2398b;

    /* renamed from: c */
    private static final float f2399c;
    ...
    static {
        ...
        f2398b = fArr;
        f2399c = 1.0f / ((float) (fArr.length - 1));
    }
    ...
    public final float getInterpolation(float f) {
        ...
        if (f < 1.0f) {
            ...
            if (f > 0.0f) {
                ...
                float f3 = f2399c;
                float[] fArr2 = f2398b;
                return fArr2[min] + (((f - (((float) min) * f3)) / f3) * (fArr2[min + 1] - fArr2[min]));
            }
        }
        return f2;
    }
