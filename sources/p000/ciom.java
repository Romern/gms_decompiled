...
public final class ciom extends bxvk implements bxxd {
    ...
    public final void mo86264c() {
        if (!this.f191094j.mo73666a()) {
            this.f191094j = bxvk.m124021a(this.f191094j);
        }
    }
}
