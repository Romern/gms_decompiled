...
public final class bmdj extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bmdj bmdj = new bmdj();
        f128803l = bmdj;
        GeneratedMessageLite.m124024a(bmdj.class, bmdj);
    }
