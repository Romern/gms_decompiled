...
public final class axto {
    ...
    /* renamed from: b */
    private static byte[] m83188b(String str) {
        try {
    ...
    /* renamed from: a */
    static final boolean m83186a(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return m83187a(packageInfo, f96328a, f96329b);
        }
        return m83187a(packageInfo, f96328a);
    }

    /* renamed from: a */
    private static final boolean m83187a(PackageInfo packageInfo, byte[]... bArr) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: axto.a(android.content.pm.PackageInfo, boolean):boolean
     arg types: [android.content.pm.PackageInfo, int]
     candidates:
      axto.a(android.content.pm.PackageInfo, byte[][]):boolean
      axto.a(android.content.pm.PackageInfo, boolean):boolean */
    /* renamed from: a */
    public final boolean mo53534a(String str) {
        PackageInfo packageInfo;
        try {
            packageInfo = svr.m36484b(this.f96331d).mo26176b(str, 64);
        ...
        if (rfy.m33550g(this.f96331d)) {
            return m83186a(packageInfo, true);
        }
        boolean a = m83186a(packageInfo, false);
        if (a || !m83186a(packageInfo, true)) {
            return a;
        }
