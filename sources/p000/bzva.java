...
public final class bzva extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bzva bzva = new bzva();
        f171489j = bzva;
        GeneratedMessageLite.m124024a(bzva.class, bzva);
    }
