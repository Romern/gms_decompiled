...
public final class apzu extends GeneratedMessageLite implements bxxd {
    ...
    static {
        apzu apzu = new apzu();
        f85290j = apzu;
        GeneratedMessageLite.m124024a(apzu.class, apzu);
    }
