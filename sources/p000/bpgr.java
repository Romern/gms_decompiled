...
public final class bpgr extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bpgr bpgr = new bpgr();
        f137526x = bpgr;
        GeneratedMessageLite.m124024a(bpgr.class, bpgr);
    }
