...
public final class bphb extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bphb bphb = new bphb();
        f137617k = bphb;
        GeneratedMessageLite.m124024a(bphb.class, bphb);
    }
