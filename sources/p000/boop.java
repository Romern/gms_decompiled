...
public final class boop extends GeneratedMessageLite implements bxxd {
    ...
    static {
        boop boop = new boop();
        f133965n = boop;
        GeneratedMessageLite.m124024a(boop.class, boop);
    }
