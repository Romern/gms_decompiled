...
public final class awkz extends awjx {
    ...
    public awkz(Intent intent) {
        super("com.google.android.gms.wallet.firstparty.ACTION_EMBEDDED_SETTINGS", "flow_embedded_settings", true, intent);
    }
