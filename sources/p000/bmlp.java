...
public final class bmlp extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bmlp bmlp = new bmlp();
        f129947h = bmlp;
        GeneratedMessageLite.m124024a(bmlp.class, bmlp);
    }
