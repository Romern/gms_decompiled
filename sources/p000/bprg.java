...
public final class bprg extends GeneratedMessageLite implements bxxd {
    ...
    static {
        bprg bprg = new bprg();
        f138829s = bprg;
        GeneratedMessageLite.m124024a(bprg.class, bprg);
    }
