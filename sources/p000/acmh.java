...
final class acmh extends acly {
    public acmh(Resources resources) {
    ...
    public final void mo32877a(acmz acmz, long j, String str, int i, String str2, int i2) {
        ...
        acmu.m49482a(acmz2.f60209a.f60197g, str);
        acmy acmy = acmz2.f60213e;
        acmy.f60208a.put(Long.valueOf(j), acms.m49472c(acmz2.f60214f, j, str, i, str2, i2));
    }
}
