...
public final class lth extends bxvk implements bxxd {
    ...
    public final void mo19598a() {
        if (!this.f32926k.mo73666a()) {
            this.f32926k = bxvk.m124021a(this.f32926k);
        }
    }
}
