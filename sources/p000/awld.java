...
public final class awld extends awjx {
    ...
    public awld(Intent intent) {
        super("com.google.android.gms.wallet.firstparty.ACTION_DELETE_INSTRUMENT", "flow_im", true, intent);
    }
