...
public final class cdgy implements cdgw {

    /* renamed from: a */
    public static final bdyx f180899a;

    static {
        bdyw a = new bdyw(bdyj.m91581a("com.google.android.gms.contextmanager")).mo58443a();
        try {
            byte[] bArr = new byte[MfiClientException.TYPE_ILLEGAL_LINKAGE_DATA];
            bArr[0] = 10;
            bArr[1] = 7;
            bArr[2] = 8;
            bArr[3] = 0;
    ...
    /* renamed from: a */
    public final bxmj mo77610a() {
        return (bxmj) f180899a.mo58455c();
    }
}
