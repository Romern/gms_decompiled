...
public class ge_add {
    public static void ge_add(ge_p1p1 ge_p1p1, ge_p3 ge_p3, ge_cached ge_cached) {
        int[] iArr = new int[10];
        fe_add.fe_add(ge_p1p1.f192133X, ge_p3.f192141Y, ge_p3.f192140X);
        fe_sub.fe_sub(ge_p1p1.f192134Y, ge_p3.f192141Y, ge_p3.f192140X);
        fe_mul.fe_mul(ge_p1p1.f192135Z, ge_p1p1.f192133X, ge_cached.YplusX);
        int[] iArr2 = ge_p1p1.f192134Y;
        fe_mul.fe_mul(iArr2, iArr2, ge_cached.YminusX);
